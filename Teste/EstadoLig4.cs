            ...
            for (int col = 0; col < COLUNAS; col++)
            {
                ...
                {                  
                    if (!IsCelulaVazia(row, col))
                    {
                        ...
                        else if ((tabuleiro[row, col] == O) && (tabuleiro[row + 1, col] == O))
                        {
                            conta++;
                            if (conta >= 4)
                                return O;
            ...
            for (int row = 0; row < LINHAS; row++)
            {
                ...
                for (int col = 0; col < COLUNAS; col++)
                {
                    if (!IsCelulaVazia(row, col))
                    {
                        ...
                        else if ((tabuleiro[row, col] == O) && (tabuleiro[row, col + 1] == O))
                        {
                            conta++;
                            if (conta >= 4)
                                return O;
            ...
            for (int row = 0; row < LINHAS; row++)
            {
                ...
                for (int col = 0; col < COLUNAS; col++)
                {
                    ...
                    for (int i = 0; i + row < LINHAS && col - i >= 0; i++)
                        {
                            if ((tabuleiro[row, col] == X) && (tabuleiro[row + i, col - i] == X))
                            {
                                conta++;
                                if (conta >= 4)
                                    return X;
                            }
                            else if ((tabuleiro[row, col] == O) && (tabuleiro[row + i, col - i] == O))
                            {
                                conta++;
                                if (conta >= 4)
                                    return O;
